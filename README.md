...
- Open text files in the built-in syntax-aware editor, using the same One Light/One Dark Pro palette as Markdown code blocks, and save with external-change protection. Markdown, HTML, and SVG previews share accessible Preview/Code tabs with mouse and keyboard navigation.
