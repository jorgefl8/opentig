...
The packaged desktop installer is Windows x64 only. The Node.js CLI runs on Linux, macOS, and Windows and serves the same browser UI. Linux with systemd also supports background service installation and browser-driven updates.
