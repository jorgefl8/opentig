      ...
      <Virtualizer className="viewer-scroll" contentClassName="viewer-content">
        {unresolved > 0 ? (
          <UnresolvedFile
            ...
            options={{ themeType, theme: JUSTGIT_DIFF_THEMES, diffIndicators: 'classic', overflow, mergeConflictActionsType: 'none', unsafeCSS: VIEWER_SCROLLBAR_CSS }}
          ...
          <File
            ...
            options={{ themeType, theme: JUSTGIT_DIFF_THEMES, overflow, unsafeCSS: VIEWER_SCROLLBAR_CSS }}
          />
        )}
      </Virtualizer>
    </div>
