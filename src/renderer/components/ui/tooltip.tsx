...
// Hover-intent delay for every tooltip in the app: long enough that tooltips
// stop firing while the pointer only crosses a toolbar, short enough to still
// feel like a hover hint.
